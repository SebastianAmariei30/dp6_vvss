...
public class TasksOperationsTest {
    ...
    void F02_incoming_tasksIsNotEmptyAndHasDatesInInterval_returnExpectedTasks() {
        ...
        tasks.add(new Task("TASK1", new Date(1980, 04, 15, 12,30)));
        // valid
        tasks.add(new Task("TASK2", new Date(1980, 04, 20, 12,30)));
        tasks.add(new Task("TASK3", new Date(1980, 04, 25, 12,30)));
        // end valid
        tasks.add(new Task(null, new Date(1980, 04, 30, 12,30)));

        TasksOperations top = new TasksOperations(tasks);

        // Act
        ArrayList<Task> result = (ArrayList<Task>) top.incoming(new Date(1980, 04, 17, 12,30), new Date(1980, 04, 25, 12,30));
    ...
    void F02_incoming_tasksHasTwoElementsAndHasDatesInInterval_returnExpectedTasks() {
        ...
        // Act
        ArrayList<Task> result = (ArrayList<Task>) top.incoming(new Date(79, 04, 17, 12,30), new Date(81, 04, 26, 12,30));
        for (Task t : result) {
